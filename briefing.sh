#!/bin/bash
# ============================================================
# briefing.sh — IAM In Trouble: The Narrative Dump
# Typewriter-style storytelling. No emojis.
# ============================================================
...
sleep 0.3
_type_color "$YELLOW" "  [T-5:59:00] [!] Bot scrapes credentials within 30 seconds" 0.02
sleep 0.3
...
echo ""
echo -e "  ${GREEN}  +------------------------------------------------------+${RESET}"
echo -e "  ${GREEN}  |${RESET}  ${WHITE}[1]${RESET} Terminate the crypto-miner                       ${GREEN}|${RESET}"
