...
- [ ] 1. Set up project structure and core interfaces
  - [ ] 1.1 Create the `iam-in-trouble` directory and initialize project files
...
- [ ] 2. Implement SetupService (`setup.py`)
  - [ ] 2.1 Implement LocalStack connectivity check and boto3 session creation
  ...
  - [ ] 2.2 Implement EC2 provisioning
  ...
  - [ ] 2.5 Wire setup.py main orchestration
...
- [ ] 3. Implement VerifyService (`verify.py`)
  - [ ] 3.1 Implement argument validation and dispatch
  ...
  - [ ] 3.2 Implement Level 1 verification (EC2 termination check)
  ...
  - [ ] 3.3 Implement Level 2 verification (S3 ACL check)
  ...
  - [ ] 3.4 Implement Level 3 verification (IAM policy check)
  ...
  - [ ]* 3.5 Write property test for EC2 verification decision
  ...
  - [ ]* 3.6 Write property test for S3 ACL verification decision
  ...
  - [ ]* 3.7 Write property test for IAM policy verification decision
  ...
  - [ ]* 3.8 Write property test for invalid level argument rejection
